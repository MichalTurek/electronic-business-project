...
class appAppKernelDevDebugContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => 'mariadb', 'port' => '', 'dbname' => 'prestashop', 'user' => 'root', 'password' => 'root', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('hQtthrv4OPbssRAMTq7ziS3mIbgFSNCQFeJ7xZ9kgXHTRIGh8RTNPtMoZmNCTp88'))), '/_fragment');
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                20 => 'ps_distributionapiclient',
                21 => 'gsitemap',
                22 => 'ps_googleanalytics',
                23 => 'gridhtml',
                24 => 'statscheckup',
                25 => 'dashactivity',
                26 => 'statsforecast',
            ...
            'modules_translation_paths' => [
                ...
                19 => (\dirname(__DIR__, 4).'/modules/gsitemap/translations'),
                20 => (\dirname(__DIR__, 4).'/modules/ps_googleanalytics/translations'),
                21 => (\dirname(__DIR__, 4).'/modules/gridhtml/translations'),
                22 => (\dirname(__DIR__, 4).'/modules/statscheckup/translations'),
                23 => (\dirname(__DIR__, 4).'/modules/dashactivity/translations'),
                24 => (\dirname(__DIR__, 4).'/modules/statsforecast/translations'),
                25 => (\dirname(__DIR__, 4).'/modules/statssales/translations'),
                26 => (\dirname(__DIR__, 4).'/modules/ps_wirepayment/translations'),
                27 => (\dirname(__DIR__, 4).'/modules/ps_emailalerts/translations'),
                28 => (\dirname(__DIR__, 4).'/modules/ps_crossselling/translations'),
                29 => (\dirname(__DIR__, 4).'/modules/statsnewsletter/translations'),
                30 => (\dirname(__DIR__, 4).'/modules/statscatalog/translations'),
                31 => (\dirname(__DIR__, 4).'/modules/ps_viewedproduct/translations'),
                32 => (\dirname(__DIR__, 4).'/modules/statsregistrations/translations'),
                ...
                38 => (\dirname(__DIR__, 4).'/modules/dashgoals/translations'),
                39 => (\dirname(__DIR__, 4).'/modules/statsbestvouchers/translations'),
                40 => (\dirname(__DIR__, 4).'/modules/statsproduct/translations'),
                41 => (\dirname(__DIR__, 4).'/modules/statsdata/translations'),
            ...
            'kernel.secret' => 'hQtthrv4OPbssRAMTq7ziS3mIbgFSNCQFeJ7xZ9kgXHTRIGh8RTNPtMoZmNCTp88',
