...
$this->privates['fragment.renderer.hinclude'] = $instance = new \Symfony\Component\HttpKernel\Fragment\HIncludeFragmentRenderer(($this->services['twig'] ?? $this->getTwigService()), ($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('hQtthrv4OPbssRAMTq7ziS3mIbgFSNCQFeJ7xZ9kgXHTRIGh8RTNPtMoZmNCTp88'))), NULL);
